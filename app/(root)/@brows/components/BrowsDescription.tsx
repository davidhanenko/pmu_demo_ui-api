export const BrowsDescription = () => {
  return (
    <div className='absolute text-white top-0 sm:top-auto sm:bottom-0 right-0 md:w-[55%] h-full md:h-[300px] lg:h-[350px] flex flex-col justify-end z-20 p-6 md:p-8 tracking-wider overflow-scroll sm:overflow-visible'>
      <div className='h-full w-full'>
        <p className='text-sm md:text-base '>
          ...
          Brows is a semi-permanent eyebrow enhancement
          method that provides a soft and natural powdered
          effect. This technique is ideal for clients who
        ...
        <p className='pt-4 text-sm md:text-base'>
          ...
          that perfectly complement your
        </p>
      </div>
    </div>
  );
